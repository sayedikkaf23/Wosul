exports.fgot_template = function (name){
    return (
        `<!DOCTYPE HTML
            ...
            <tr style="vertical-align: top">
              <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                ...
                <div class="u-row-container"
                  style="padding: 0px;background-image: url('https://yeep.s3.me-south-1.amazonaws.com/email_template/01.png');background-repeat: no-repeat;background-position: center top;background-color: transparent">
                  <div class="u-row"
                          ...
                          <div
                            ...
                            <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0"
                              ...
                              <tbody>
                                <tr>
                                  <td
                                    style="overflow-wrap:break-word;word-break:break-word;font-family:'Lato',sans-serif; background-image: url('https://yeep.s3.me-south-1.amazonaws.com/email_template/02.png');background-repeat: no-repeat;background-position: center top;background-color: transparent; background-size: 125% 100%;"
                                    align="center">
      
                                    <div style="height: 84vh; padding-top: 16vh;" >
                                    <div
                                      style="color: #7c8180; line-height: 100%; text-align: center; word-wrap: break-word;">
                                      <!-- <p style="font-size: 14px; line-height: 100%;"><span
                                          style="font-size: 8vh; line-height: 8vh;"><span
                                            style="line-height: 72px; font-size: 72px;"><strong><span
                                                style="color: #e03e2d; line-height: 8vh; font-size: 8vh;">yeepeey</span></strong></span><span
                                            style="line-height: 8vh; color: #fff; font-size: 8vh;">.</span></span></p> -->
                                            <img width="50%" src="https://yeep.s3.me-south-1.amazonaws.com/email_template/yeepey-mailer-03.gif" alt="">
                                    </div>
                                      <div ><strong style="font-size: 5vh; color: #fff;">Forgot Your <br>Password?</strong></div>
                                      
                                      <div style="margin-top: 30px;"><strong style="color: #fff; font-size: 2.5vh; padding-top: 30px;">Dear ${name} <br>We've got your covered! <br>Please click on the <br>button below to reset <br>your password</strong></div>
                                      <div align="center" style="margin-top: 60px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Lato',sans-serif;"><tr><td style="font-family:'Lato',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:49px; v-text-anchor:middle; width:202px;" arcsize="20.5%" stroke="f" fillcolor="#ee1111"><w:anchorlock/><center style="color:#ffffff;font-family:'Lato',sans-serif;"><![endif]-->
                                        <a href="https://yeepeey.com/app" target="_blank"
                                          style="box-sizing: border-box;display: inline-block;font-family:'Lato',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #e32327; border-radius: 10px;-webkit-border-radius: 10px; -moz-border-radius: 10px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-width: 0px; border-top-style: solid; border-top-color: #22225f; border-left-width: 0px; border-left-style: solid; border-left-color: #22225f; border-right-width: 0px; border-right-style: solid; border-right-color: #22225f; border-bottom-width: 0px; border-bottom-style: solid; border-bottom-color: #22225f;">
                                          <span style="display:block;padding:5px 15px;line-height:160%;"><span
                                              style="font-size: 18px; line-height: 28.8px;"><strong><span
                                                  style="line-height: 28.8px; font-size: 18px;">Reset your passowrd
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      <tr>
                                        <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                          ...
                                          <img align="center" border="0" src="https://yeep.s3.me-south-1.amazonaws.com/email_template/image-4.png" alt="" title=""
                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 303px;"
                                            width="303" />
                                  ...
                                  <td
                                    ...
                                    <div style="color: #444444; line-height: 140%; text-align: left; word-wrap: break-word;">
                                      <p style="line-height: 140%; text-align: center; font-size: 14px;"><span
                                          style="color: #e03e2d; font-size: 14px; line-height: 19.6px;"><strong><span
