exports.order_placed_template = function (name, is_schedule, order_id, total, mode, address ){
    return (
        `<!DOCTYPE HTML
                        ...
                        <div
                          ...
                          <div
                                    ...
                                    <div
                                      ...
                                      <p style="font-size: 14px; line-height: 100%;"><span
                                          style="color: #e32327; font-size: 14px; line-height: 14px;"><strong><span
                                              style="font-size: 22px; line-height: 22px;">Thank You</span></strong></span></p>
                                      <p style="font-size: 14px; line-height: 100%;"><span
                                          style="font-size: 22px; line-height: 22px; color: #e32327;">For your order</span>
                                      </p>
                                    </div>
                                      ...
                                      <tr>
                                        <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                          ...
                                          <img align="center" border="0"
                                            src="https://yeep.s3.me-south-1.amazonaws.com/email_template/order-placed.gif"
                                            alt="" title=""
                              ...
                              <tbody>
                                <tr>
                                  <td
                                    ...
                                    <div
                                      style="color: #1b302b; line-height: 100%; text-align: center; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 100%;">Dear ${name}</p>
                                      <p style="font-size: 14px; line-height: 100%;"><strong><span
                                            style="color: #e32327; font-size: 14px; line-height: 14px;">Thank
                                            you</span></strong> for choosing <span
                                          style="color: #e32327; font-size: 14px; line-height: 14px;"><strong>yeepeey</strong></span>&nbsp;for
                                        your</p>
                              ...
                              <tbody>
                                <tr>
                                  <td
                                    ...
                                    <div
                                      style="color: #1b302b; line-height: 100%; text-align: center; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 100%;">Your order <strong># ${order_id}</strong>
                                        has been received
                                      </p>
                                      <p style="font-size: 14px; line-height: 100%;">&amp; is currently&nbsp; under process
                                      </p>
                                      <p style="font-size: 14px; line-height: 100%;">You can now track your order on App.</p>
                                    </div>
                              ...
                              <tbody>
                                <tr>
                                  <td
                                    ...
                                    <div
                                      style="color: #1b302b; line-height: 100%; text-align: center; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 100%;">See you soon!</p>
                                    </div>
                            ...
                            <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0"
                              ...
                              <tbody>
                                <tr>
                                  <td style="word-break:break-word;font-family:'Lato',sans-serif;"
                                    align="center">
                                    <div
                                      style="color: #1b302b; line-height: 100%; display: flex; word-wrap: break-word; justify-content: space-between !important;">
                                      <div style="text-align: left;">
                                        <p
                                          style="font-size: 14px; line-height: 100%; padding-bottom: 15px; padding-top: 15px;">
                                          <strong>
                                            <span style="color: #e32327; font-size: 14px; line-height: 14px; ">Order Summary
                                            </span>
                                          </strong>
                                        </p>
                                        <p style="font-size: 14px; line-height: 100%; padding-bottom: 5px;">
                                          <span style="color: #1b302b; font-size: 14px; line-height: 14px;">Order No. :
                                          </span>
                                          <strong>
                                            <span style="color: #1b302b; font-size: 14px; line-height: 14px;"># ${order_id}
                                            </span>
                                          </strong>
                                        </p>
                                        <p style="font-size: 14px; line-height: 100%; padding-bottom: 5px;">
                                          <span style="color: #1b302b; font-size: 14px; line-height: 14px;">Estimated Total :
                                          </span>
                                          <strong>
                                            <span style="color: #1b302b; font-size: 14px; line-height: 14px;">AED ${total}
                                            </span>
                                          </strong>
                                        </p>
                                        <p style="font-size: 14px; line-height: 100%;">
                                          <span style="color: #1b302b; font-size: 14px; line-height: 14px;">Payment Mode :
                                          </span>
                                          <strong>
                                            <span style="color: #1b302b; font-size: 14px; line-height: 14px;">${mode}
                                            </span>
                                          </strong>
                                        </p>
                                      </div>
                                      <div style="text-align: left; margin-left: 5vw;">
                                        <p
                                          style="font-size: 14px; line-height: 100%; padding-bottom:15px; padding-top: 15px;">
                                          <strong><span style="color: #e32327; font-size: 14px; line-height: 14px;">Delivery
                                              Address
                                            </span></strong>
                                        </p>
                                        <p style="font-size: 14px; line-height: 100%; padding-bottom: 5px;">
                                          <span style="color: #1b302b; font-size: 14px; line-height: 14px;">Scheduled Delivery
                                            :
                                          </span>
                                          <strong>
                                            <span style="color: #1b302b; font-size: 14px; line-height: 14px;">${is_schedule}
                                            </span>
                                          </strong>
                                        </p>
                                        <p style="font-size: 14px; line-height: 100%;">
                                          <span style="color: #1b302b; font-size: 14px; line-height: 14px;">${address}
                                          </span>
                                        </p>
                                      </div>
                                      <!-- <p style="font-size: 14px; line-height: 100%;">groceries and more! </p> -->
                                            ...
                                            <tr style="vertical-align: top">
                                              <td align="left" valign="middle"
                                                ...
                                                <a href="https://www.facebook.com/yeepeey/" title="Facebook" target="_blank">
                                                  <img
                                                    src="https://yeep.s3.me-south-1.amazonaws.com/email_template/image-1.png"
                                        ...
                                        <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32"
                                          ...
                                          <tbody>
                                            <tr style="vertical-align: top">
                                              <td align="left" valign="middle"
                                                style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                <a href="https://www.linkedin.com/company/yeepeey-online-grocery-shopping-app/"
                                                  title="LinkedIn" target="_blank">
                                                  <img
                                                    src="https://yeep.s3.me-south-1.amazonaws.com/email_template/image-3.png"
                                        ...
                                        <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32"
                                          ...
                                          <tbody>
                                            <tr style="vertical-align: top">
                                              <td align="left" valign="middle"
                                                style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                <a href="https://www.instagram.com/yeepeey_uae/" title="Instagram"
                                                  target="_blank">
                                                  <img
                                                    src="https://yeep.s3.me-south-1.amazonaws.com/email_template/image-2.png"
