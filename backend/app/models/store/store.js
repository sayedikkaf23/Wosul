...
var store = new schema(
  {
    ...
    is_main_store: { type: Boolean, default: false },
    is_business: { type: Boolean, default: true },
    is_approved: { type: Boolean, default: false },
    is_send_mail_report: { type: Boolean, default: true },
    ...
    under_item_price: { type: Number, default: 1 },
    ...
    is_taking_schedule_order: { type: Boolean, default: true },
    inform_schedule_order_before_min: { type: Number, default: 0 },
    min_order_for_loyalty: { type: Number, default: 0 },
    is_loyalty_payment_visible: { type: Boolean, default: true },
    schedule_order_create_after_minute: { type: Number, default: 0 },

    yeep_earninig_percent_for_card: { type: Number, default: 0 },
    yeep_earninig_percent_for_cash: { type: Number, default: 0 },
    yeep_earninig_percent_for_online: { type: Number, default: 0 },
    ...
    ask_password_timer: { type: Number, default: 0 },
    store_sequence: { type: Number },
    // RATE INFO
    ...
    auto_complete_order: { type: Number, default: 25 },
    ...
    //show CASH/COD/ONLINE PAYMENT
    is_show_cash: { type: Boolean, default: true },
    is_show_card_on_delivery: { type: Boolean, default: false },
    is_show_online_payment: { type: Boolean, default: false },

    //show min. order for cash/COD/ONLINE PAYMENT
    min_price_for_cash: { type: Number, default: 1 },
    min_price_for_card_on_delivery: { type: Number, default: 1 },
    min_price_for_online_payment: { type: Number, default: 1 },
    min_price_for_wallet: { type: Number, default: 30 },

    //delivery fees

    delivery_fees: { type: Number, default: 1 },
    ...
    is_cash_visible: { type: Boolean, default: true },
    is_card_on_delivery_visible: { type: Boolean, default: true },
    is_online_payment_visible: { type: Boolean, default: true },
    is_wallet_visible: { type: Boolean, default: true },
    is_store_can_complete_order: { type: Boolean, default: false },
    is_show_user_info: { type: Boolean, default: false },

    // categotory to be shown in store or not
    is_category_available: { type: Boolean, default: true },

    //show Items in home page based on store selection
    show_items_home_page: { type: Boolean, default: false },

    radius_regions: { type: Array, default: [] },
    sub_stores: { type: Array, default: [] },
    tags: { type: Array, default: [] },
    images: { type: Array, default: [] },
    info: { type: String, default: "" },

    //add rating type
    rating_type: { type: String, default: "Top Rated" },

    //store delivery fees from store timing
    is_delivery_fees_from_store_timing: { type: Boolean, default: false },
          ...
          day_time: [
            {
              ...
              store_close_time: "10:00",
            },
            {
              store_open_time: "10:00",
              store_close_time: "11:00",
            },
            {
              store_open_time: "11:00",
              store_close_time: "12:00",
            },
            {
              store_open_time: "12:00",
              store_close_time: "13:00",
            },
            {
              store_open_time: "13:00",
              store_close_time: "14:00",
            },
            {
              store_open_time: "14:00",
              store_close_time: "15:00",
            },
            {
              store_open_time: "15:00",
              store_close_time: "16:00",
            },
            {
              store_open_time: "16:00",
              store_close_time: "17:00",
            },
            {
              store_open_time: "17:00",
            ...
            {
              store_open_time: "20:00",
              store_close_time: "21:00",
            },
            {
              store_open_time: "21:00",
              store_close_time: "22:00",
            },
            {
              store_open_time: "22:00",
    ...
    free_delivery_text: { type: String, default: "" },
    paid_delivery_text: { type: String, default: "" },
    created_at: {
      type: Date,
      default: Date.now,
    },
