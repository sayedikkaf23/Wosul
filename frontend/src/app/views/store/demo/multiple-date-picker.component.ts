  ...
  implements OnInit, ControlValueAccessor
{
  ...
  @Input() cssDaysOfSurroundingMonths: any =
  ...
  isDayOff(day) {
    return (
      ...
      (this.weekDaysOff instanceof Array &&
      ...
      (this.daysAllowed === Array &&
        !this.daysAllowed.some(function (dayAllowed) {
          return day.date.isSame(dayAllowed, 'day');
        })) ||
      (Object.prototype.toString.call(this.highlightDays) ===
        '[object Array]' &&
        this.highlightDays.some(function (highlightDay) {
          return (
            day.date.isSame(highlightDay.date, 'day') &&
            !highlightDay.selectable &&
            highlightDay.css
          );
        }))
    );
