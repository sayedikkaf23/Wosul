...
export class StoreProviderComponent implements OnInit {
    ...
    this.helper.http
      ...
      .subscribe(
        (res_data: any) => {
          ...
          if (res_data.success == false) {
            this.vehicle_list = [];
            this.modalService.open(this.vehicle_modal);
          } else {
  ...
  add_new_provider() {
    this.modalService.open(this.add_new_provider_modal);
  }

  add_new_vehicle() {
    this.modalService.open(this.add_vehicle_modal);
  }
  ...
  addVehicle() {
    ...
    this.myLoading = true;
    this.helper.http
      .post('/admin/add_vehicle', this.add_vehicle)
      .subscribe((res_data: any) => {
        this.myLoading = false;
        if (res_data.success) {
          this.helper.data.storage = {
  ...
  AddProvider() {
    ...
    this.myLoading = true;
    this.helper.http
      .post('/store/add_new_provider', this.add_provider)
      .subscribe((res_data: any) => {
        this.myLoading = false;
        if (res_data.success) {
          this.add_provider = {};
