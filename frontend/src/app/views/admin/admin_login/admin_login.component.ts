...
export class admin_loginComponent implements OnInit {
  ...
  readonly VAPID_PUBLIC_KEY = "BIhgIFptceIR6rslMhr4COrEofQ4Gkr7iDq2MR4727vJQBr5uAL3tI76h7Wg2sEl3sttfDqGLz64rO4VI1x9nKM";
  ...
  .then(sub => {
    ...
    this.helper.http.post('/admin/add_update_subscription', apiData)
