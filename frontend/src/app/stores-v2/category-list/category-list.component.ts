...
export class CategoryListComponent implements OnInit {
  @ViewChild('addCategory') addCategoryModal;
  private modalRef;
  store_id: any;
  category_list: any = [];
  ...
  ngOnInit() {
    this.add_category = {
      ...
      server_token: '',
      sequence_number: 0,
      image_url: 'assets/images/empty-image.svg',
    ...
    this.storeService.getAdminImageSetting({}).subscribe(
      (res_data: any) => {
      ...
      this.helper.http
        ...
        .subscribe((res_data: any) => {
          ...
          if (res_data.success == false) {
            ...
            this.add_category.is_special_category =
              res_data.category.is_special_category;
  ...
  addCategory(category_data) {
    ...
    if (this.type == 'add') {
      ...
      this.formData.append(
        ...
        category_data.category_arabic_name
      );
      this.formData.append(
        'category_arabic_description',
        category_data.category_arabic_description
      );
      this.formData.append('description', category_data.description);

      this.formData.append('store_id', category_data.store_id);
      this.formData.append(
        'is_special_category',
        category_data.is_special_category
      );
      ...
      this.storeService.addStoreCategory(this.formData).subscribe(
        (res_data: any) => {
          this.myLoading = false;
          if (res_data.success == false) {
            this.helper.data.storage = {
          ...
          this.getCategory();
          this.router.navigate(['store/category_list']);
        },
        (error: any) => {
          this.myLoading = false;
          this.helper.http_status(error);
  ...
  addCategoryData(add_category) {
    this.addCategory(add_category);
  }
}
