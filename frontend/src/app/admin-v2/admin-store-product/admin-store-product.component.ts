...
@Component({
  selector: 'app-admin-store-product',
  templateUrl: './admin-store-product.component.html',
  styleUrls: ['./admin-store-product.component.css'],
  providers: [Helper, ImageCropperComponent],
})
export class AdminStoreProductComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.helper.router_id.admin.store_id) {
      ...
      this.helper.router_id.admin.store_id = urlTree.fragment;
    }
